...
class composed_loss_function(nn.Module):
    ...
    def forward(self,pred_,Y_obs,rrs_,rrs_pred,nan_array, param):
        ...
        return rrs_error + 2*obs_error #+ 0.00001*param.mean()
...
torch.save(model.state_dict(),'/Users/carlos/Documents/OGS_one_d_model/plot_data/model_state_dict_VAE.npy')
...
def save_var_uncertainties(model, X, chla_hat_mean, covariance_matrix,rrs_hat, constant = None, save_path ='/Users/carlos/Documents/OGS_one_d_model/results_VAE_VAEparam',dates = [] ):
